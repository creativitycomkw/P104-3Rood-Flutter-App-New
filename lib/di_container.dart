...
import 'package:flutter_ecommerce/features/address/domain/repositories/address_repository_interface.dart';
import 'package:flutter_ecommerce/features/address/domain/services/address_service.dart';
import 'package:flutter_ecommerce/features/address/domain/services/address_service_interface.dart';
import 'package:flutter_ecommerce/features/auth/controllers/facebook_login_controller.dart';
import 'package:flutter_ecommerce/features/auth/controllers/google_login_controller.dart';
...
import 'package:flutter_ecommerce/features/auth/domain/services/auth_service.dart';
import 'package:flutter_ecommerce/features/auth/domain/services/auth_service_interface.dart';
import 'package:flutter_ecommerce/features/banner/controllers/banner_controller.dart';
import 'package:flutter_ecommerce/features/banner/domain/repositories/banner_repository.dart';
import 'package:flutter_ecommerce/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:flutter_ecommerce/features/banner/domain/services/banner_service.dart';
import 'package:flutter_ecommerce/features/banner/domain/services/banner_service_interface.dart';
import 'package:flutter_ecommerce/features/brand/domain/repositories/brand_repo_interface.dart';
import 'package:flutter_ecommerce/features/brand/domain/repositories/brand_repository.dart';
import 'package:flutter_ecommerce/features/brand/domain/services/brand_service.dart';
import 'package:flutter_ecommerce/features/brand/domain/services/brand_service_interface.dart';
import 'package:flutter_ecommerce/features/cart/domain/repositories/cart_repository.dart';
import 'package:flutter_ecommerce/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:flutter_ecommerce/features/cart/domain/services/cart_service.dart';
import 'package:flutter_ecommerce/features/cart/domain/services/cart_service_interface.dart';
import 'package:flutter_ecommerce/features/category/domain/repositories/category_repo.dart';
import 'package:flutter_ecommerce/features/category/domain/repositories/category_repo_interface.dart';
import 'package:flutter_ecommerce/features/category/domain/services/category_service.dart';
import 'package:flutter_ecommerce/features/category/domain/services/category_service_interface.dart';
import 'package:flutter_ecommerce/features/chat/domain/repositories/chat_repository.dart';
import 'package:flutter_ecommerce/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:flutter_ecommerce/features/chat/domain/services/chat_service.dart';
import 'package:flutter_ecommerce/features/chat/domain/services/chat_service_interface.dart';
...
import 'package:flutter_ecommerce/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:flutter_ecommerce/features/checkout/domain/services/checkout_service.dart';
import 'package:flutter_ecommerce/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:flutter_ecommerce/features/compare/controllers/compare_controller.dart';
import 'package:flutter_ecommerce/features/compare/domain/repositories/compare_repository.dart';
import 'package:flutter_ecommerce/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:flutter_ecommerce/features/compare/domain/services/compare_service.dart';
import 'package:flutter_ecommerce/features/compare/domain/services/compare_service_interface.dart';
import 'package:flutter_ecommerce/features/contact_us/controllers/contact_us_controller.dart';
import 'package:flutter_ecommerce/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:flutter_ecommerce/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:flutter_ecommerce/features/contact_us/domain/services/contact_us_service.dart';
import 'package:flutter_ecommerce/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:flutter_ecommerce/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:flutter_ecommerce/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:flutter_ecommerce/features/coupon/domain/services/coupon_service.dart';
import 'package:flutter_ecommerce/features/coupon/domain/services/coupon_service_interface.dart';
...
import 'package:flutter_ecommerce/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:flutter_ecommerce/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:flutter_ecommerce/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:flutter_ecommerce/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:flutter_ecommerce/features/deal/domain/services/featured_deal_service.dart';
import 'package:flutter_ecommerce/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:flutter_ecommerce/features/deal/domain/services/flash_deal_service.dart';
import 'package:flutter_ecommerce/features/deal/domain/services/flash_deal_service_interface.dart';
...
import 'package:flutter_ecommerce/features/location/domain/repositories/location_repository_interface.dart';
import 'package:flutter_ecommerce/features/location/domain/services/location_service.dart';
import 'package:flutter_ecommerce/features/location/domain/services/location_service_interface.dart';
import 'package:flutter_ecommerce/features/loyaltyPoint/controllers/loyalty_point_controller.dart';
import 'package:flutter_ecommerce/features/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:flutter_ecommerce/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
import 'package:flutter_ecommerce/features/loyaltyPoint/domain/services/loyalty_point_service_interface.dart';
...
import 'package:flutter_ecommerce/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:flutter_ecommerce/features/notification/domain/services/notification_service.dart';
import 'package:flutter_ecommerce/features/notification/domain/services/notification_service_interface.dart';
import 'package:flutter_ecommerce/features/onboarding/controllers/onboarding_controller.dart';
import 'package:flutter_ecommerce/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:flutter_ecommerce/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:flutter_ecommerce/features/onboarding/domain/services/onboarding_service.dart';
import 'package:flutter_ecommerce/features/onboarding/domain/services/onboarding_service_interface.dart';
import 'package:flutter_ecommerce/features/order/controllers/order_controller.dart';
import 'package:flutter_ecommerce/features/order/domain/repositories/order_repository.dart';
import 'package:flutter_ecommerce/features/order/domain/repositories/order_repository_interface.dart';
import 'package:flutter_ecommerce/features/order/domain/services/order_service.dart';
import 'package:flutter_ecommerce/features/order/domain/services/order_service_interface.dart';
import 'package:flutter_ecommerce/features/order_details/controllers/order_details_controller.dart';
import 'package:flutter_ecommerce/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:flutter_ecommerce/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:flutter_ecommerce/features/order_details/domain/services/order_details_service.dart';
import 'package:flutter_ecommerce/features/order_details/domain/services/order_details_service_interface.dart';
import 'package:flutter_ecommerce/features/product/controllers/product_controller.dart';
import 'package:flutter_ecommerce/features/product/controllers/seller_product_controller.dart';
import 'package:flutter_ecommerce/features/product/domain/repositories/product_repository.dart';
import 'package:flutter_ecommerce/features/product/domain/repositories/product_repository_interface.dart';
import 'package:flutter_ecommerce/features/product/domain/repositories/seller_product_repository.dart';
import 'package:flutter_ecommerce/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:flutter_ecommerce/features/product/domain/services/product_service.dart';
import 'package:flutter_ecommerce/features/product/domain/services/product_service_interface.dart';
import 'package:flutter_ecommerce/features/product/domain/services/seller_product_service.dart';
import 'package:flutter_ecommerce/features/product/domain/services/seller_product_service_interface.dart';
import 'package:flutter_ecommerce/features/product_details/controllers/product_details_controller.dart';
import 'package:flutter_ecommerce/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:flutter_ecommerce/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:flutter_ecommerce/features/product_details/domain/services/product_details_service.dart';
import 'package:flutter_ecommerce/features/product_details/domain/services/product_details_service_interface.dart';
...
import 'package:flutter_ecommerce/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:flutter_ecommerce/features/profile/domain/services/profile_service.dart';
import 'package:flutter_ecommerce/features/profile/domain/services/profile_service_interface.dart';
import 'package:flutter_ecommerce/features/refund/controllers/refund_controller.dart';
import 'package:flutter_ecommerce/features/refund/domain/repositories/refund_repository.dart';
import 'package:flutter_ecommerce/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:flutter_ecommerce/features/refund/domain/services/refund_service.dart';
import 'package:flutter_ecommerce/features/refund/domain/services/refund_service_interface.dart';
import 'package:flutter_ecommerce/features/reorder/controllers/re_order_controller.dart';
import 'package:flutter_ecommerce/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:flutter_ecommerce/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:flutter_ecommerce/features/reorder/domain/services/re_order_service.dart';
import 'package:flutter_ecommerce/features/reorder/domain/services/re_order_service_interface.dart';
import 'package:flutter_ecommerce/features/restock/controllers/restock_controller.dart';
import 'package:flutter_ecommerce/features/restock/domain/repositories/restock_repository.dart';
import 'package:flutter_ecommerce/features/restock/domain/repositories/restock_repository_interface.dart';
import 'package:flutter_ecommerce/features/restock/domain/services/restock_service.dart';
import 'package:flutter_ecommerce/features/restock/domain/services/restock_service_interface.dart';
import 'package:flutter_ecommerce/features/review/controllers/review_controller.dart';
import 'package:flutter_ecommerce/features/review/domain/repositories/review_repository.dart';
import 'package:flutter_ecommerce/features/review/domain/repositories/review_repository_interface.dart';
import 'package:flutter_ecommerce/features/review/domain/services/review_service.dart';
import 'package:flutter_ecommerce/features/review/domain/services/review_service_interface.dart';
import 'package:flutter_ecommerce/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:flutter_ecommerce/features/search_product/domain/services/search_product_service.dart';
import 'package:flutter_ecommerce/features/search_product/domain/services/search_product_service_interface.dart';
import 'package:flutter_ecommerce/features/shipping/controllers/shipping_controller.dart';
import 'package:flutter_ecommerce/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:flutter_ecommerce/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:flutter_ecommerce/features/shipping/domain/services/shipping_service.dart';
import 'package:flutter_ecommerce/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:flutter_ecommerce/features/shop/domain/repositories/shop_repository.dart';
import 'package:flutter_ecommerce/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:flutter_ecommerce/features/shop/domain/services/shop_service.dart';
import 'package:flutter_ecommerce/features/shop/domain/services/shop_service_interface.dart';
import 'package:flutter_ecommerce/features/splash/controllers/splash_controller.dart';
import 'package:flutter_ecommerce/features/splash/domain/repositories/splash_repository.dart';
import 'package:flutter_ecommerce/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:flutter_ecommerce/features/splash/domain/services/splash_service.dart';
import 'package:flutter_ecommerce/features/splash/domain/services/splash_service_interface.dart';
import 'package:flutter_ecommerce/features/support/controllers/support_ticket_controller.dart';
import 'package:flutter_ecommerce/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:flutter_ecommerce/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:flutter_ecommerce/features/support/domain/services/support_ticket_service.dart';
import 'package:flutter_ecommerce/features/support/domain/services/support_ticket_service_interface.dart';
import 'package:flutter_ecommerce/features/wallet/controllers/wallet_controller.dart';
import 'package:flutter_ecommerce/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:flutter_ecommerce/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:flutter_ecommerce/features/wallet/domain/services/wallet_service.dart';
import 'package:flutter_ecommerce/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:flutter_ecommerce/features/wishlist/controllers/wishlist_controller.dart';
import 'package:flutter_ecommerce/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:flutter_ecommerce/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:flutter_ecommerce/features/wishlist/domain/services/wishlist_service.dart';
import 'package:flutter_ecommerce/features/wishlist/domain/services/wishlist_service_interface.dart';
import 'package:flutter_ecommerce/helper/network_info.dart';
...
import 'package:flutter_ecommerce/features/search_product/controllers/search_product_controller.dart';
