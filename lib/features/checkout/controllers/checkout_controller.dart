...
import 'package:flutter_ecommerce/features/offline_payment/domain/models/offline_payment_model.dart';
...
import 'package:flutter_ecommerce/features/checkout/screens/digital_payment_order_place_screen.dart';
...
class CheckoutController with ChangeNotifier {
  ...
  void setAddressIndex(int? index) {
    _addressIndex = index;
    notifyListeners();
    // will dynamiccally load available shipping method based on address selection
